...
const initialCards = [
  {
    ...
    bg: "scene1.png",
    badge: "Scene 1 / 6",
    title: "A quiet Ghibli meadow",
    caption: "Welcome to a small, peaceful corner of the world, crafted just to say I appreciate you and hope you have a beautiful day.",
    hint: "Swipe left to begin →",
    theme: "card-1"
  },
  {
    index: 1,
    bg: "scene2.png",
    badge: "Scene 2 / 6",
    title: "The Flying Airship",
    caption: "Honestly, navigating your busy daily schedule feels like chasing a fast-moving airship! ✈️ But no matter how hectic things get, our chats are like finding a cozy bakery in Koriko — always the absolute highlight of my day.",
  ...
  },
  {
    ...
    bg: "scene3.png",
    badge: "Scene 3 / 6",
    title: "Our little soot sprites",
    caption: "The hilarious late-night voice notes, the inside jokes, and the random things that make us laugh. They are like soot sprites: tiny, chaotic, and filling our friendship with warmth and magic ✨.",
    hint: "Swipe left to continue →",
    theme: "card-3"
  },
  {
    ...
    bg: "scene4.png",
    badge: "Scene 4 / 6",
    title: "A quiet train ride",
    caption: "Sometimes life gets overwhelming, and the path ahead feels a bit quiet or distant. But like the train in Spirited Away, you don't have to journey alone — I'll always be here to share the seat next to you.",
    hint: "Swipe left to continue →",
    theme: "card-4"
  },
  {
    ...
    caption: "I wanted to take a moment to say how incredibly grateful I am to have you as a friend. Your kindness and humor bring a special magic to everything, much like a cozy cottage hidden in the hills 🏡.",
    hint: "Swipe left to continue →",
    theme: "card-5"
  },
  {
    ...
    caption: "To the person who makes the world a lot warmer: may your new year be filled with beautiful landscapes, gentle adventures, and lots of joy. Claim your birthday treat below!",
    captionSpan: "I hope this year is incredibly gentle and good to you.",
    footnote: "Have an amazing birthday, Captain! 🎁✨",
    redeemable: true,
    theme: "card-6"
  }
];
